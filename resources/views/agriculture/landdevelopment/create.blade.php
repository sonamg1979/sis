...
color: red;
    ...
    <div class="card card-body" style="max-width: 40rem;">
        <h3>Add: Land Development</h3><hr>
        {!! Form::open(['action' => 'LandDevelopmentController@store','method' => 'POST','enctype'=>'multipart/form-data']) !!}
            ...
            {{Form::text('location',null,['class'=>'form-control','id'=>'location', 'placeholder' =>'Location Name'])}}
